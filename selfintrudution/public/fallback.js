...
const rooms = {
  ...
  gallery: {
    ...
    label: '经历',
    title: '实习与项目经历',
    body: '这里展示 Sealos 系统组实习、CompliK、GCFeed、SDD Agent Engine 和 GoClub，把工程经历集中放进项目房间。',
    ...
    items: [
      ...
      { title: 'SDD Agent Engine', text: 'VS Code、RAG、多 Agent、自动门禁、文档回写', image: '/textures/studio/monitorfront_postnafbdoublewinner.webp', type: 'object', alt: 'Agent 工程项目展示屏' },
